...
const WithdrawModal = ({ isOpen, setIsOpen, method, amount }) => {
    return (
        <>
            <Modal isOpen={isOpen} setIsOpen={setIsOpen} >
                <div className="p-3 flex flex-col items-center gap-4 w-full">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button onClick={() => setIsOpen(false)} className="btn btn-sm bg-blue-600 text-white hover:bg-blue-800">Withdraw</button>
                    </div>
                </div>
            </Modal>
        </>
